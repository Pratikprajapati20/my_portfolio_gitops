            ...
            <Card className="h-100 project-card border-0 shadow-sm">
              <Card.Body className="p-4">
                ...
                <div className="mb-3">
                  {project.tags.map((tag, tagIndex) => (
                    <Badge key={tagIndex} bg="danger" className="me-2 mb-2">{tag}</Badge>
                  ))}
                </div>
              ...
              <Card.Footer className="bg-white border-0 p-4">
                <div className="d-flex justify-content-center">
                  <Button className="me-2" variant="outline-dark" href={project.github} target="_blank" rel="noopener noreferrer">
                    <FaGithub className="me-2" /> GitHub
                  </Button>

                  <Button variant="outline-dark" href={project.github} target="_blank" rel="noopener noreferrer">
                    <SiHashnode className="me-2" /> Hashnode
                  </Button>
                </div>
              </Card.Footer>
            </Card>
