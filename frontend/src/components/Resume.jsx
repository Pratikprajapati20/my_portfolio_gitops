...
const Resume = () => {
  const googleDriveFileId = "1Z2p4z-gxJDyYruIhBQD-Uu7tik7nUwiJ";
  //const googleDriveFileId = "16qUPS5RGIQLmQng2k5aPiD3-K5M5XH8f"; // replace with your actual file ID
      ...
      <Row className="mb-4">
        <Col lg={8} className="mx-auto text-center">
          <Button
            ...
            download="Pratik_Prajapati_Resume.pdf"
            variant="primary"
            size="lg"
      ...
      <Row>
        <Col lg={9} className="mx-auto">
          <PDFFrame
            ...
            title="Pratik Prajapati's Resume"
            allow="autoplay"
          />
        </Col>
      </Row>
